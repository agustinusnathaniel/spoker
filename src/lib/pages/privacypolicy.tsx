...
export const PrivacyPolicy = () => (
  <SpokerWrapperGrid gap={4}>
    ...
    <Text>
      At spoker, accessible from spoker.sznm.dev, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by spoker and how we use it.
    </Text>
    ...
    <Text>
      ...
      and/or collect in spoker. This policy is not applicable to any information
